const BLOG = {
  title: 'Wordle helper helps you find todays wordle answer',
  ...
  path: '/article', // leave this empty unless you want to deploy Nobelium in a folder
  ...
  socialLink: 'https://playwordleunlimited.com',
  seo: {
  ...
  analytics: {
    ...
    gaConfig: {
      measurementId: 'G-HJVCWL1X6W' // e.g: G-XXXXXXXXXX
    }
  },
  comment: {
